# Generated by Django 5.0.6 on 2025-03-14 17:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('visibility', models.CharField(choices=[('PUBLIC', 'Public'), ('PRIVATE', 'Private'), ('UNLISTED', 'Unlisted')], db_default='PRIVATE', default='PRIVATE', max_length=255)),
                ...
                ('tags', models.ManyToManyField(blank=True, to='icosa.tag')),
            ],
        ),
        migrations.CreateModel(
            name='DeviceCode',
