...
DATA_UPLOAD_MAX_MEMORY_SIZE = None  # Danger
INSTALLED_APPS = [
    "dal",
    "dal_select2",
    "django.contrib.auth",
...
if not LOCAL_MEDIA_STORAGE:
    INSTALLED_APPS = ["s3upload"] + INSTALLED_APPS
    S3UPLOAD_DESTINATIONS = {"jrtest": {"key": "jrtest"}}
    S3UPLOAD_REGION = DJANGO_STORAGE_REGION_NAME
    S3UPLOAD_BUCKET_ENDPOINT = f"{DJANGO_STORAGE_URL}/{DJANGO_STORAGE_BUCKET_NAME}"
